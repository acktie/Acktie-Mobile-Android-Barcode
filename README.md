# Acktie Mobile Barcode Module (Android)
...
This function returns a view (TIView) that scans a Barcode code from the live
...
Use this property to indicate to the View to NOT auto-detect the Barcode Code.
